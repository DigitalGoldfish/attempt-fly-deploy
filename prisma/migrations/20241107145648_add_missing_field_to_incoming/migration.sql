...
CREATE TABLE "new_Incoming" (
    ...
    "kvreceived" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Incoming" ("bereich", "comment", "createdAt", "formSubmissionId", "id", "inquiry", "kundennr", "kvbestaetiungsId", "kvsent", "kvuploaded", "mailId", "mitarbeiter", "neuanlage", "ohneverordnung", "orderNr", "printed", "printedAt", "produktanlage", "source", "status", "svTraegerId", "type", "updatedAt", "verordnungsId", "wiedervorlage") SELECT "bereich", "comment", "createdAt", "formSubmissionId", "id", "inquiry", "kundennr", "kvbestaetiungsId", "kvsent", "kvuploaded", "mailId", "mitarbeiter", "neuanlage", "ohneverordnung", "orderNr", "printed", "printedAt", "produktanlage", "source", "status", "svTraegerId", "type", "updatedAt", "verordnungsId", "wiedervorlage" FROM "Incoming";
DROP TABLE "Incoming";
